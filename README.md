...
## 功能特点
<img width="1286" height="880" alt="图片" src="https://github.com/user-attachments/assets/909ba890-d08b-44fc-a6ff-b1a7d20a6496" />

- **自动检测**: 基于 YOLO26n 微调训练后的深度学习模型，自动识别扫描图中的每张照片
